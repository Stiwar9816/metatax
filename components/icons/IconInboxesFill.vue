<template>
	<div>
		<svg
			...
			height="16"
			fill="currentColor"
			class="bi bi-inboxes-fill flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900 dark:text-gray-400 dark:group-hover:text-white"
			viewBox="0 0 16 16"
		>
			<path
