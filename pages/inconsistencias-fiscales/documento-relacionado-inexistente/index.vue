<template>
    <div>
        <ButtonsButtonRoute home="Inconsistencias fiscales" route-active="Pago con documento relacionado inexistente" />
...
<script setup lang="ts">
    useHead({ title: `CFDI's de pago con documento relacionado inexistente` });
    // Types
    ...
    const fields = ref([
        ...
        { field: 'tax_folio_payment_voucher', title: 'Folio Fiscal del comprobante de pago' },
    ...
    const itemsTable = [
        {
            ...
            tax_folio_payment_voucher: 'sdfs-423sa-134124',
            rfc: 'ASO13357804',
