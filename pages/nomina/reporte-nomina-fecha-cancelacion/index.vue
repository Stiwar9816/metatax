<template>
    <div>
        <ButtonsButtonRoute home="Nómina" route-active="Reporte de CFDI por fecha de cancelación" />
...
<script setup lang="ts">
    useHead({ title: 'Reporte de CFDI por fecha de cancelación' });
    const fields = ref([
        { field: 'client', title: 'Folio fiscal' },
        { field: 'client', title: 'RFC' },
