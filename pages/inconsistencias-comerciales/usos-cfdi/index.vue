<template>
    <div>
        <ButtonsButtonRoute home="Inconsistencias comerciales" route-active="Usos CDFI's" />
...
<script setup lang="ts">
    useHead({ title: `Inconsistencias de usos de CDFI's` });
    // Types
    ...
    const fields = ref([
        ...
        { field: 'tax_regime', title: 'Regímen fiscal' },
        { field: 'expedition_place', title: 'Lugar de expedición' },
        ...
        { field: 'way_to_pay', title: 'Forma de pago' },
    ...
    const itemsTable = [
        {
            ...
            tax_regime: 625,
            use_cfdi: 'G03 - Gastos generales',
            expedition_place: 112344,
            currency: 'MXN',
